            ...
            init: function (e) {
                ...
                c.element instanceof HTMLElement && (c.element.addEventListener("mousedown", r.bind(e), !0), c.element.addEventListener("focus", i.bind(e), !0)),
                    ...
                    e.on("render", function (e) {
                        Array.from(
                            e.querySelectorAll([".month-item:first-child:not(.no-previous-month) .button-previous-month", ".month-item:last-child:not(.no-next-month) .button-next-month", ".reset-button", "select"].join(","))
                        ).forEach(function (e) {
                            return (e.tabIndex = 1);
                        });
                    }),
                            ...
                            (i.innerText = a),
                                ...
                                i.addEventListener("click", function (n) {
                                    ...
                                    if (r) {
                                        ...
                                        t.autoApply ? (e.setDateRange(a, o, t.force), e.emit("ranges.selected", a, o), e.hide()) : ((e.datePicked = [a, o]), e.emit("ranges.preselect", a, o)),
